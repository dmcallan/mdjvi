...
% ---------------------------------------------------------------
%
% Adapatado para o Departamento de Eng. de Sistemas e Computação pelo
...
Esse banco de dados deverá ser exibido em um novo site, contendo um sistema de pesquisa de fácil utilização onde através de um ou mais parâmetros definidos pelo usuário ele possa obter uma resposta rápida sobre as peças desejadas.
...
A instalação do providence é baseada em um perfil, onde é descrito toda a estrutura do gerenciamento de banco de dados do catálogo a ser importado e a administração do museu sobre o mesmo. Este perfil contém as informações que podem ser preenchidas para um objeto (categoria, localização, estado atual, entre outros), uma localização
