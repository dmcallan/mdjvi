...
<?php
				print caNavLink($this->request, caGetThemeGraphic($this->request, 'mdjvi.png'), "navbar-brand", "", "","");
?>
			</div>
				...
				<ul class="nav navbar-nav navbar-right menuItems">
					...
					<li class="<?php print (($this->request->getController() == "About") && ($this->request->getAction() != "teachers") && ($this->request->getAction() != "support") && ($this->request->getAction() != "Index")) ? 'active' : ''; ?> dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Ajuda</a>
						<ul class='dropdown-menu'>
							...
							<li><?php print caNavLink($this->request, _t("Planeje sua Visita"), "", "", "About", "plansv"); ?></li>
						</ul>
					</li>
	...
	<div class="container"><div class="row"><div class="col-xs-12">
		<div id="pageArea" <?php print caGetPageCSSClasses(); ?>>
			<form class="navbar-form big <?php print $vs_class; ?>" role="search" action="<?php print caNavUrl($this->request, '', 'MultiSearch', 'Index'); ?>">
				<div class="formOutline">
					<div class="form-group">
						<input type="text" class="form-control" placeholder="Busque em nossas Coleções" name="search">
					</div>
					<button type="submit" class="btn-search"><span class="glyphicon glyphicon-search"></span></button>
				</div>
			</form>
