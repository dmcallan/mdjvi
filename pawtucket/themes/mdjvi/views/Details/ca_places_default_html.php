		...
		<div class="container">
			...
			<div class="row">			
				<div class='col-md-6 col-lg-6'>
					...
					{{{<ifcount code="ca_objects" min="1" max="1"><div class='unit'><unit relativeTo="ca_objects" delimiter=" "><l>^ca_object_representations.media.large</l><div class='caption'>Objeto Relacionado: <l>^ca_objects.preferred_labels.name</l></div></unit></div></ifcount>}}}
